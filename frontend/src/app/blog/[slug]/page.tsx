    ...
    <div className="min-h-screen bg-background selection:bg-primary selection:text-black pt-32 pb-20 transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto px-6 space-y-20">
        ...
        <motion.div 
          ...
          className="prose prose-xl prose-invert max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tighter prose-p:text-slate-300 prose-p:font-medium prose-p:leading-8 prose-strong:text-white prose-li:text-slate-300 prose-li:marker:text-primary"
          dangerouslySetInnerHTML={{ 
            __html: post.content
              .replace(/\n\n/g, '</p><p class="mb-6">')
              .replace(/\n/g, '<br />')
              .replace(/## (.*)/g, '<h2 class="text-3xl md:text-5xl mt-16 mb-8 text-white uppercase tracking-tighter leading-none">$1</h2>')
